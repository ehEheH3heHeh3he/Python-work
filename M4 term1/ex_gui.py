...
photo1 = PhotoImage(file='apple.png')
photo2 = PhotoImage(file='banana.png')
photo3 = PhotoImage(file='orenge.png')
photo4 = PhotoImage(file='Melon.png')
label1 = Label(text = '        MENU   ',bg = 'peach puff')
label2 = Label(text = '      SELECT: ',bg = 'peach puff')
